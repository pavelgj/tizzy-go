	...
	err = app.Run(
		func(ctx *tz.RenderContext) tz.Node {
			return tz.NewBox(
				...
				tz.NewText(tz.Style{Color: tcell.ColorGreen}, "Green Text"),
				tz.NewText(tz.Style{Color: tcell.ColorRed, Background: tcell.ColorWhite}, "Red on White"),
				tz.NewBox(
					tz.Style{
						Border: true,
						Color:  tcell.ColorYellow,
					},
					tz.NewText(tz.Style{}, "Yellow Border Box"),
				),
